...
export class PipelineStack extends cdk.Stack {
    ...
    constructor(scope: Construct, id: string, props?: cdk.StackProps) {
        ...
        cdk_nag.NagSuppressions.addStackSuppressions(this, [
            {
                id: 'AwsSolutions-IAM5',
                reason: 'IAM Roles and policies are provisioned by CDK. These are not user controlled.',
            },
            {
                id: 'AwsSolutions-CB4',
                reason: 'Project uses CDK pipelines and build artifacts are encrypted using S3 managed keys.',
            },
            {
                id: 'AwsSolutions-S1',
                reason: 'S3 bucket is used for storing CodePipeline artifacts. Bucket policy is restricted by default and access loggig is not required for this.',
            },
        ])
